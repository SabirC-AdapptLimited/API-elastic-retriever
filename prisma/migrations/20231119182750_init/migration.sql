...
-- CreateEnum
CREATE TYPE "DashboardType" AS ENUM ('Homepage', 'Active', 'Disabled');
...
-- CreateIndex
CREATE UNIQUE INDEX "org_inviteCode_key" ON "org"("inviteCode");

-- CreateIndex
CREATE INDEX "org_profileId_idx" ON "org"("profileId");
...
-- CreateIndex
CREATE INDEX "Dashboard_profileId_idx" ON "Dashboard"("profileId");
...
-- AddForeignKey
ALTER TABLE "org" ADD CONSTRAINT "org_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Dashboard" ADD CONSTRAINT "Dashboard_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Dashboard" ADD CONSTRAINT "Dashboard_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "org"("id") ON DELETE CASCADE ON UPDATE CASCADE;
